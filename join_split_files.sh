...
cat vendor/etc/saiv/aisolution_1.0/PAPAYA_0731.nnc.* 2>/dev/null >> vendor/etc/saiv/aisolution_1.0/PAPAYA_0731.nnc
rm -f vendor/etc/saiv/aisolution_1.0/PAPAYA_0731.nnc.* 2>/dev/null
